...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-row-padding">
    <div class="w3-third w3-container w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        ...
        <p>In mijn eerste jaar webdeveloper heb ik een hotelsite moeten maken. <a href="http://u534237.gluweb.nl/hotelsite/" target="_blank">Klik hier</a> om de site te bekijken en misschine wel een geweldige vakantie te boeken. </p>
      </div>
    </div>
    <div class="w3-third w3-container w3-margin-bottom">
    ...
    <div class="w3-third w3-container">
      ...
      <div class="w3-container w3-white">
        <p><b>JS game 2</b></p>
        <p>Dit is de laatste JS opdracht die ik heb gemaakt. ik heb boter kaas en eieren gemaakt met behulp van react helaas kon ik de game niet online zetten.</p>
      </div>
    </div>
  </div>
  ...
  <div class="w3-row-padding">
    <div class="w3-third w3-container w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        <p><b>JS rekenmachine</b></p>
        <p>Dit Rekenmachine Project was een simpel maar leuk Project. <a href="http://u534237.gluweb.nl/rekenmachine" target="_blank">Klik hier</a> om de rekenmachine te bekijken en wat leuke sommen uit te rekenen. </p></p>
      </div>
    </div>
    <div class="w3-third w3-container w3-margin-bottom">
...
<!-- 
  ...
  <div class="w3-container w3-padding-large" style="margin-bottom:32px">
    <h4><b>About Me</b></h4>
    <p>Ik ben Tim van Rossem 17 jaar en studeer nu aan het Grafisch Lyceum Utrecht. Ik doe de opleiding webdeveloper ik zit nu in me 2de jaar.</p>
    <hr>
